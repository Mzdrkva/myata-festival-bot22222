...
# Создайте рядом config.json со структурами:
# {
...
# ====== Загрузка/сохранение сцены и избранного ======
...
def faq_kb():
    opts = [
        ...
        "Карта Фестиваля", "Расписание pracy душевых",
...
FAQ_TEXTS = {
    "О фестивале": (
        ...
        "В 2025 году зрителей на 7 сценах ждет более 120 концертов и dj-сетов. Рок, инди, фолк, альтернатива, фанк, джаз, электроника — мультиформатная «Дикая Мята» представляет артистов всех актуальных жанров.\n\n"
        "На фестивале выступят THE HATTERS, Три дня дождя, ZOLOTO, АРИЯ, ХЛЕБ, SALUKI, polnalyubvi, DRUMMATIX, Заточка, БАЗАР, Jane Air, TMNV, Пётр Налич, ГУДТАЙМС, Бонд с кнопкой, СмешBand, Luverance, Кирпичи Big Band, The OM, MONOLYT (IL), Stigmata, мытищи в огне, PALC, OLIGARKH, Мультfильмы, Драгни, Beautiful boys, хмыров, Manapart, Конец солнечных дней, Кamilla Robertovna, CARDIO KILLER, Sula fray, obraza net, 3333, Собачий Lie, ХОХМА, The Translators, Манго Буст, Yan Dilan, Бюро, МОЛОДОСТЬ ВНУТРИ, Пальцева Экспириенс, Людмил Огурченко, Breaking System, Brodsky, uncle pecos, Стрио, соня хочет танцевать, Juzeppe Junior, Лолита Косс, Остыл, Melekess, El Mashe, Дедовский Свитер, Baby Cute, Антон Прокофьев, Breakpillzz, Мама не узнает, GOKK’N’TONY, Можем хуже, RASPUTNIKI (KZ), Inna Syberia, без обид, Давай, LITHIUM, Каспий, Три вторых, Рубеж Веков, синдром главного героя, Koledova, я Софа, Mazzltoff, ielele, Polina Offline, Ник Брусковский, ROFMAN, летяга, Tabasco Band, Гнев Господень, Дисциплина безбольной биты, Hideout, Савелiчъ Бэнд, ParadigmA, Клуб 33 и другие, новые анонсы каждую неделю!\n\n"
        "«Дикая Мята» по праву считается самым комфортным опен-эйром страны. Организованная парковка, бесплатная питьевая вода и душевые с горячей водой, дорожки, выложенные тротуарной плиткой, освещенные палаточные кемпинги, которые размечены на улицы и индивидуальные места под палатки, комната матери и ребенка, бассейн, видовой ресторан и арт-амбар, sup-станция и лаундж-зоны.\n"
        "Фудкорт фестиваля предлагает кухни мира на любой вкус и кошелек, вегетарианскую зону и атмосферную перголу с блюдами от шеф-поваров.\n\n"
        "Также для гостей представлено множество развлечений:\n"
        "— В пространстве Green Age проходят йога-практики, экстатик дэнс, арт-медитации, мастер-классы по нейрографике и лекции о здоровом образе жизни.\n"
        "— В бьюти-зоне можно создать свой яркий фестивальный образ, здесь работают мастера брейдинга и макияжа, открыт барбершоп.\n"
        "— Гости с детьми особо ценят Территорию детства, где есть Детская сцена «Ариэль», работают карусели и аттракционы, проводятся бесплатные мастер-классы, открыт детский сад с опытными аниматорами, в этом году впервые примет участие студия анимационного кино «Мельница» — приедут любимые мультгерои Лунтик, Барбоскины и Три богатыря.\n"
        "— Большая фестивальная ярмарка собирает лучших мастеров хэндмейда, авторской одежды, аксессуаров и украшений со всей страны.\n"
        "— На спортивной площадке есть воркаут-зона, проходят турниры по пляжному волейболу.\n"
        "— Партнеры фестиваля предлагают бесконечное множество призовых активностей и лаундж-зоны для отдыха гостей.\n\n"
    ...
    "Расписание pracy душевых": "Текст по теме «Расписание работы душевых»...",
...
def get_entries_for_date(scene: str, iso_date: str):
    ...
    for tstr, artist in SCENES.get(scene, []):
        ...
        # если время <02:00 следующего дня — относим к дню до полуночи
...
async def cmd_start(msg: types.Message):
    ...
    with open(WELCOME_IMAGE, "rb") as photo:
        await bot.send_photo(msg.chat.id, photo=photo, caption=welcome, reply_markup=main_menu_kb())

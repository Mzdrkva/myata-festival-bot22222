...
def faq_kb():
    opts = [
        ...
        "Можно ли заехать на фестиваль заранее?",
...
FAQ_TEXTS = {
    ...
    "Место под палатку": (
        ...
        "Если ваша палатка большего размера или вам необходимо место под тент — вы приобретаете два и более билетов категории «Место под палатку», в зависимости от нужной вам площади.\n\n"
...
async def faq_answer(msg: types.Message):
    # Отправляем текст для выбранного FAQ-пункта

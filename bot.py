...
FAQ_TEXTS = {
    ...
    "Место под палатку": (
        "На территории фестиваля открыты несколько палаточных лагерей, а билеты «Место под палатка» продаются по местам — вы заранее выбираете ряд (улицу) и место для своей палатки на сайте:\n\n"
        ...
        "Билет категории «Место под палатка» дает право установки своей палатки размером 3×4 м. Место необходимо занять строго в соответствии с номерами ряда и места в выбранном лагере — они указываются при оформлении покупки и на самом билете.\n"

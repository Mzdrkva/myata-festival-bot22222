...
DEFAULT_SCENES = {
    ...
    "TITANA": [
        ...
        # чуть-чуть за полночь, будет в списке 13 июня
...
def get_entries_for_date(scene: str, iso_date: str):
    ...
    for tstr, artist in SCENES.get(scene, []):
        ...
        # включаем события в 00:30 как вечер предыдущего дня
...
async def faq_about(msg: types.Message):
    text = (
        ...
        "«Дикая Мята» по праву считается самым комфортным опен-эйром страны. "
        "Организованная парковка, бесплатная питьевая вода и душевые с горячей водой, "
        "дорожки, выложенные тротуарной плиткой, освещенные палаточные кемпинги, "
        "которые размечены на улицы и индивидуальные места под палатки, комната матери и ребенка, "
        "бассейн, видовой ресторан и арт-амбар, sup-станция и лаундж-зоны.\n\n"
        "Фудкорт фестиваля предлагает кухни мира на любой вкус и кошелек, вегетарианскую зону и "
        "атмосферную перголу с блюдами от шеф-поваров.\n\n"
        ...
        "— В бьюти-зоне можно создать свой яркий фестивальный образ, здесь работают мастера "
        "брейдинга и макияжа, открыт барбершоп.\n"
        "— Гости с детьми особо ценят Территорию детства, где есть Детская сцена «Ариэль», "
        "работают карусели и аттракционы, проводятся бесплатные мастер-классы, открыт детский сад "
        "с опытными аниматорами, в этом году впервые примет участие студия анимационного кино «Мельница» — "
        "приедут любимые мультгерои Лунтик, Барбоскины и Три богатыря.\n"

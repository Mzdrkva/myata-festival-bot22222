...
FAQ_TEXTS = {
    "Открытие дверей": (
        ...
        "гиперссылка: https://mintmusic.ru/rules).\n"
        ...
        "(гиперссылка: https://vk.com/away.php?to=https%3A%2F%2Fmintmusic.ru%2Frules&cc_key=).\n"
    ...
    "Как доехать до фестиваля, трансферы на фестиваль": (
        ...
        "(гиперссылка: https://mintmusic.ru/how-to-get-there/bus-tours) и официальными трансферами фестиваля "
        "(гиперссылка: https://mintmusic.ru/transfer).\n\n"
